                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <Card className="bg-card border-border hover-glow">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <CheckCircle className={`h-4 w-4 ${analyticsData.completionRate >= 80 ? 'text-emerald-400' :
                                    analyticsData.completionRate >= 60 ? 'text-amber-400' : 'text-red-400'
                                    }`} />
                            </CardHeader>
                            <CardContent>
                                <div className={`text-2xl font-bold ${analyticsData.completionRate >= 80 ? 'text-emerald-400' :
                                    analyticsData.completionRate >= 60 ? 'text-amber-400' : 'text-red-400'
                                    }`}>
                        ...
                        <Card className="bg-card border-border hover-glow">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <Activity className={`h-4 w-4 ${analyticsData.systemHealth >= 95 ? 'text-emerald-400' :
                                    analyticsData.systemHealth >= 80 ? 'text-amber-400' : 'text-red-400'
                                    }`} />
                            </CardHeader>
                            <CardContent>
                                <div className={`text-2xl font-bold ${analyticsData.systemHealth >= 95 ? 'text-emerald-400' :
                                    analyticsData.systemHealth >= 80 ? 'text-amber-400' : 'text-red-400'
                                    }`}>
                        ...
                        <Card className="bg-card border-border">
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className={`text-sm font-medium ${analyticsData.webhookSuccessRate >= 95 ? 'text-emerald-400' :
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className={`text-sm font-medium flex items-center gap-1 ${analyticsData.systemHealth >= 95 ? 'text-emerald-400' :
                                        analyticsData.systemHealth >= 80 ? 'text-amber-400' : 'text-red-400'
                                        }`}>
